// File: C:\Users\cruz\OneDrive - Aeon Investments Technologies LLC\production websites\vulpinehomes.com\app\cabinet-refacing-globe\page.tsx
...
export default function CabinetRefacingMesaPage() {
  return (
    <>
      <ServiceSchema 
        serviceName="Cabinet Refacing Globe AZ"
        description="Professional cabinet refacing services in Globe, Arizona. Transform your kitchen with custom cabinet doors and expert installation."
        url="https://vulpinehomes.com/cabinet-refacing-globe"
        areaServed="Globe AZ"
      />
      <main className="min-h-screen bg-[#0a0a0f]">
          ...
          <div className="relative h-[500px] overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center px-4 max-w-4xl">
                ...
                <p className="text-white/70 mt-4 text-sm">✓ All Mesa Zip Codes ✓ 2-5 Day Installation ✓ Expert Craftsmanship</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Service Areas */}
        <CityAnchorLinking currentNodeId="globe" />
        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Transform Your Globe Kitchen?
            </h2>
