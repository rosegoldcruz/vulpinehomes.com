    ...
    <footer className="bg-[#08080c] border-t border-white/10 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-white/60 mb-8 max-w-md">
              Modernizing Phoenix kitchens with precision refacing and premium craftsmanship.
            </p>
            ...
            <div className="space-y-4 text-white/80">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@vulpinehomes.com" className="hover:text-white transition-colors">info@vulpinehomes.com</a>
              </div>
            </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/40">
          <p>Vulpine is a registered trade name of Vulpine LLC © 2026</p>
          <p>Powered By: The Advanced Efficient Optimized Network</p>
        </div>
      </div>
    </footer>
  );
