// File: C:\Users\cruz\OneDrive - Aeon Investments Technologies LLC\production websites\vulpinehomes.com\app\components\TabsDemo.tsx
"use client";
      ...
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-[#1a1a2e] to-[#0f0f23] border border-white/10">
          ...
          <div className="mt-4 text-lg font-normal text-white/70">
            We handle cabinet refacing from measurement to installation.
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-[#1a1a2e] to-[#0f0f23] border border-white/10">
          ...
          <div className="mt-4 text-lg font-normal text-white/70">
            Cabinet refacing specialists serving Phoenix.
          </div>
