// File: C:\Users\cruz\OneDrive - Aeon Investments Technologies LLC\production websites\vulpinehomes.com\app\areas-served\page.tsx
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center z-10 py-20">
          ...
          <p className="max-w-3xl mx-auto text-lg sm:text-xl lg:text-2xl mb-6 text-white/80 font-light px-4">
            Vulpine Homes provides cabinet refacing and door replacement across the Phoenix metro area. All installations are completed by our in-house team.
          </p>
