// File: C:\Users\cruz\OneDrive - Aeon Investments Technologies LLC\production websites\vulpinehomes.com\app\privacy\page.tsx
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 md:p-12 space-y-8 text-gray-300">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li><strong className="text-white">Contractors:</strong> On-site professionals who may work on your project</li>
