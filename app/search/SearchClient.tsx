// File: C:\Users\cruz\OneDrive - Aeon Investments Technologies LLC\production websites\vulpinehomes.com\app\search\SearchClient.tsx
"use client";
...
export default function SearchClient() {
  ...
  const hasAny = pageResults.length + cityResults.length > 0;
    ...
    <>
      <section className="pt-24 pb-10">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-white/60 mb-6">Find pages and service areas.</p>
          <input
            value={q}
